...
import {Button, Divider, Flex, Grid, HStack, ListItem, Text, UnorderedList, useToast} from "@chakra-ui/react";
            ...
            {swMileageDetail.status === 1 &&
              <Flex w={'100%'} justify={'flex-end'}>
                <HStack align={'flex-end'} spacing={'16px'}>
                  ...
                  <Button colorScheme={'gray'} onClick={() => denyMileage()} isDisabled={!isAble} minWidth={'fit-content'}>
                    거절
                  </Button>
                </HStack>
              </Flex>
